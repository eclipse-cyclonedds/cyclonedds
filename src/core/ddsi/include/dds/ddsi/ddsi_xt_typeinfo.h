...
typedef struct DDS_XTypes_CompleteEnumeratedHeader DDS_XTypes_CompleteBitmaskHeader;
...
typedef struct DDS_XTypes_MinimalEnumeratedHeader DDS_XTypes_MinimalBitmaskHeader;
