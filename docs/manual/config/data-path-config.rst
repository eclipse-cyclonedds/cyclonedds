...
.. todo:: Needs explanation of "allowed transmition bandwidth". it's mentioned as part of 
  MaxQueuedRexmitBytes. It is hidden behind a compile time option called DDS_HAS_BANDWIDTH_LIMITING.
