...
To help explain where the DDSI specification ends and the |var-project| implementation 
begins, this section provides a high-level description of the concepts of the DDSI
