...
For the |var-project-short| Python package, ``ddsperf`` provides a graphical application 
(by running ``cyclonedds performance``).
...
.. include:: installation/test_installation.part.rst
