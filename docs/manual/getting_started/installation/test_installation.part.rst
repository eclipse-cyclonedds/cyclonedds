...
- Use the |var-project-short| with ddsperf tool
   :ref:`dsperf_tool` sends a continuous stream of data at a variable frequency. This is useful for sanity checks and to bypass other sporadic network issues.
